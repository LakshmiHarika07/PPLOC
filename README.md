...
> We deploy [ObjectTracking](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Sensor_Nodes/Node1/ObjectTracking.py), [Measurements](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Sensor_Nodes/Node1/Measurements.py), and [Encryption](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Sensor_Nodes/Node1/Encryption.py) python files in each individual sensor. We track an object (red lazer light) projected within a common plane (localised for all the sensors) by using [ObjectTracking](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Sensor_Nodes/Node1/ObjectTracking.py) script to get (x,y) coordinates. These coordinates are used in [Measurements](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Sensor_Nodes/Node1/Measurements.py) to generate the measurements using a process following a linear constant velocity model. And these measurements are encrypted (Paillier encryption using PublicKey) by using [Encryption](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Sensor_Nodes/Node1/Encryption.py) script. 
...
2. LocalHub Sensor:
> We deploy 3 python files deployed in each Individual sensors along with [LocalServer](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Local_Hub_Node/LocalServer.py) and [SensorDataAggregation](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Local_Hub_Node/SensorDataAggregation.py) python files in this LocalHub sensor. Here [SensorDataAggregation](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Local_Hub_Node/SensorDataAggregation.py) is used to aggregate the cipher measurement vectors using Paillier homomorphic addition synchronously. This localised aggragated measurement is communicated to Central node for Decryption through [LocalServer](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Local_Hub_Node/LocalServer.py)

3. Central Node:
> Here we generate Key (publicKey and PaillierPrivateKey) and we transport this publicKey (generated from [Decryption](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Central_Node/Decryption.py)) using [CentralServer](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Central_Node/CentralServer.py) to the sensors for Encryption. Also, the localised aggreagated measurement received from LocalHub sensor is decrypted at [Decryption](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Central_Node/Decryption.py). This decrypted measurements (Localised sensor measurement) are used to run the [InformationFilter](https://github.com/LakshmiHarika07/PPLOC/blob/main/Final_Code/Central_Node/InformationFilter.py).
